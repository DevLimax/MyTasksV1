...
export default function EditTaskPage() {
  ...
  if (isLoadingTask) {
    return (
      ...
      >
        <span className="text-white/30 text-sm">Carregando tarefa…</span>
      </div>
    )
  }
    ...
    >
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-white/40">Atualize os dados da tarefa</p>
        </div>
